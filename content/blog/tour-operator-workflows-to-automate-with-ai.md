...
faq:
  ...
  - question: "How long does it take to see ROI from automating a tour operator workflow?"
    answer: "For the first four workflows on the list (inbox brief, field voice memos, proposal drafting, lead response), ROI shows up in the first week. Setup is minutes to hours, not days. For the foundation-level items (vendor database, supplier confirmation automation, trip accounting), budget two to four weeks before the loop is closed and the time savings are consistent. The mistake is expecting the foundation work to pay back immediately. It pays back by multiplying the value of everything built on top of it."
  - question: "Do I need a developer or technical team to automate these workflows?"
    answer: "For the top eight workflows, no. A Claude or ChatGPT subscription and a saved prompt library are enough. For supplier confirmation automation, trip accounting, and the guide knowledge base, a consultant or developer helps accelerate the build. But even those can start as manual-then-automated projects. The common mistake is waiting for a full technical solution when a prompt-driven manual version would return most of the value this quarter."
  - question: "How accurate are the time-saved estimates in this list?"
    answer: "They are based on patterns across the operators I have audited. Your numbers will vary with team size, trip volume, and how mature your current systems are. The relative ranking holds across most operations. A 12-person experience company and a 300-person global tour operator will see different absolute savings, but both will benefit most from the inbox brief before any other workflow."
  - question: "What is the most common mistake tour operators make when starting to automate?"
